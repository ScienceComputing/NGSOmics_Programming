...
with_CondaEnv("atac",
              system2(command = "macs2",
                      args = c("callpeak",
                               "-t", "Users/your_name/Documents/ATAC_seq/Sorted_ATAC_female_lung_bowtie2_chr1X_free.bam", # Nucleosome-free open region BMA file
                               "--outdir", "Users/your_name/Documents/ATAC_seq/Sorted_ATAC_female_lung_bowtie2_chr1X_free_narrowpeak/",
                               "--format", "BAM",
                               "--name", "female_lung",
                               "-g", "hs"),
                      stdout = T))
