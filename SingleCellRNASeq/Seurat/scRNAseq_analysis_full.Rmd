...
# Cluster the cells
## Decide how many principal components are going to be used in the cell clustering, which are assumed to capture the major source of variations driving the cell types?
```{r}
...
Idents(object = multi_seurat_obj_harmony) <- "integrated_snn_res.0.6" # ? harmony_res.0.6
# multi_seurat_obj_harmony <- RunUMAP(multi_seurat_obj_harmony, reduction = "harmony", assay = "SCT", dims = 1:40)
