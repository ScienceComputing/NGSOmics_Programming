---
title: "Analysis of Mouse Single Cell RNA-Seq Data with Seurat"
author: "Anni Liu"
...
# Points on the upper right corner: two or more cells cluster in a single droplet

# Pairwise compare the read counts and mitochondrial content
FeatureScatter(obj, feature1 = "nCount_RNA", feature2 = "percent.mt")
# Points on the upper left corner: cell debris with low contents of nuclear genes (nCount_RNA) while high contents of mitochondrial genes (percent.mt)
```
...
# The second cluster may need to be removed, due to the potential cell cycle bias in much fewer proportions of G1 phases
